...
import com.example.yzbkaka.kakasports.Soccer.SoccerFragmentAdapter;

public class SpainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, ViewPager.OnPageChangeListener {  //需要继承父类
